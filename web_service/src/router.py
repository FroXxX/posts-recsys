...
def get_recomendation(
    ...
    data = np.zeros((selected_posts.shape[0],user_info.shape[0]+selected_posts.shape[1]+1), dtype=object)
    ...
    results = app.data_posts.loc[res_ind, ["topic", "text"]].reset_index().to_dict(orient="records")
    return results