...
| [data_observe.ipynb](notebooks/data_observe.ipynb)                     | Анализ исходных данных                                        |
| [BertEmbeddingsTraining.ipynb](notebooks/BertEmbeddingsTraining.ipynb) | Обработка данных, генерация фичей, оптимизация гиперпараметров и обучение модели |
